...
export const slides = [
  ...
  },
  {
    ...
    title: "Our Products",
    subtitle:
      "Compounds, footwear, resins, and industrial hardware manufactured and distributed across Ethiopia.",
    accent: "amber",
    image: "/slider-3.jpg",
  },
  {
    ...
    lineChart: {
      ...
      series: [
        {
          label: "Compounds",
          values: [62, 68, 74, 82, 90, 96],
          color: "#f59e0b",
        },
        {
          label: "Footwear",
          values: [55, 60, 72, 78, 86, 92],
          color: "#10b981",
        },
      ],
    },
  ...
  },
  {
    ...
    subtitle:
      "Real-time view of output mix, growth trends, and division performance across Mohan Group.",
    donut: {
    ...
    lineChart: {
      ...
      series: [
        {
          label: "Manufacturing",
          values: [72, 78, 84, 88, 91, 95],
          color: "#f59e0b",
        },
        {
          label: "Logistics",
          values: [65, 70, 76, 82, 87, 92],
          color: "#0ea5e9",
        },
      ],
    },
    ...
    images: [
      ...
      {
        src: "/presentation/masterbatch-pellets.png",
        caption: "Masterbatch & polymers",
        contain: true,
      },
    ],
  },
  {
    ...
    lineChart: {
      ...
      series: [
        {
          label: "Tons",
          values: [120, 135, 148, 162, 175, 190],
          color: "#0ea5e9",
        },
      ],
    },
  ...
  },
  {
    ...
    subtitle:
      "From raw compounds and masterbatches to finished footwear, furniture, and hardware.",
    donut: {
    ...
    items: [
      ...
      {
        image: "/presentation/plastic-chair-green.png",
        title: "Molded Chairs",
        category: "PVC",
        contain: true,
      },
      ...
      {
        image: "/presentation/safety-boot-features.png",
        title: "Safety Boots",
        category: "Safety",
        contain: true,
      },
  ...
  },
  {
    ...
    subtitle:
      "End-market distribution across Ethiopia's growing industrial sectors.",
    donut: {
      segments: [
    ...
    images: [
      {
        src: "/presentation/masterbatch-pellets.png",
        caption: "Packaging & polymers",
        contain: true,
      },
      {
        src: "/presentation/plastic-chairs.png",
        caption: "Construction & household",
        contain: true,
      },
      {
        src: "/presentation/gumboots.png",
        caption: "Industrial safety",
        contain: true,
      },
  ...
  },
  {
    ...
    subtitle:
      "Mohan PLC — Ethiopia's first licensed Free Zone Operator at the Dire Dawa Free Trade Zone.",
    accent: "sky",
    image: "/ddftz/gate-day-night.png",
  },
  {
    ...
    cards: [
      {
        ...
        detail:
          "Seamless near-shoring drastically reduces lead times and ensures rapid order fulfillment.",
        metric: "3×",
      ...
      },
      {
        ...
        detail:
          "Robust buffer inventories of essential commodities within the Free Zone.",
        metric: "24/7",
      ...
      },
      {
        ...
        detail:
          "Bridges global supply and local demand with industry-leading turnaround.",
        metric: "Fast",
  ...
  },
  {
    ...
    subtitle:
      "Lead-time reduction, throughput growth, and zone utilization at Dire Dawa Free Trade Zone.",
    donut: {
    ...
    lineChart: {
      ...
      series: [
        {
          label: "Port Route",
          values: [42, 40, 38, 36, 35, 34],
          color: "#94a3b8",
        },
        {
          label: "DDFTZ Route",
          values: [28, 22, 18, 14, 11, 8],
          color: "#10b981",
        },
      ],
    },
  ...
  },
  {
    ...
    images: [
      {
        src: "/ddftz/gate-day-night.png",
        caption: "DDFTZ main gate — day & night operations",
      },
      {
        src: "/ddftz/forklift-loading.png",
        caption: "Container loading & industrial fulfillment",
      },
      {
        src: "/ddftz/warehouse-yard.png",
        caption: "Warehouse yard & MSC container logistics",
      },
      {
        src: "/ddftz/warehouse-interior.png",
        caption: "High-capacity bulk storage facility",
      },
    ],
  },
  {
    ...
    subtitle:
      "Source compounds, footwear, and resins — or leverage DDFTZ near-shoring for faster industrial supply.",
    image: "/ddftz/gate-day-night.png",
    links: [
  ...
  },
  {
    ...
    subtitle:
      "Scan the QR code to explore our full website, products, and DDFTZ operations.",
    qr: "/presentation/qr-code.png",
    url: "https://www.highlandershoe.com/",
    urlLabel: "highlandershoe.com",
  },
];
